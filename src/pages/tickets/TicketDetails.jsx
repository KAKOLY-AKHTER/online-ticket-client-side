...
//   const booking = { ticketId: ticket._id, quantity };
...
//     // ✅ Navigate to MyBookedTickets page
...
//   const departurePassed = new Date(`${ticket.departureDate} ${ticket.departureTime}`) < new Date();
...
//       <p><span className="font-medium">Route:</span> {ticket.from} → {ticket.to}</p>
//       <p><span className="font-medium">Transport:</span> {ticket.transportType}</p>
//       <p><span className="font-medium">Price:</span> ৳{ticket.price}</p>
//       <p><span className="font-medium">Available Quantity:</span> {ticket.quantity}</p>
//       <p><span className="font-medium">Departure:</span> {ticket.departureDate} at {ticket.departureTime}</p>
//       <p><span className="font-medium">Countdown:</span> {countdown}</p>
